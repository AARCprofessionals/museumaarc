<div class="menu-main-container" id="navigation">
  <ul class="menu" id="dropmenu">
    ...
    <li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item" id="menu-item-plugs"><a href="https://store.aarc.org/detail.aspx?id=BRICK">Donate</a></li>
  </ul>
</div>
